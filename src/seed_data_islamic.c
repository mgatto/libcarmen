...
void carmen_seed_build_islamic_world(CarmenWorld *w)
{
    ...
    { ClueData c[] = {{"The suspect was googling Bosnian coffee recipes",                                          "sarajevo", CARMEN_CLUE_POSITIVE},
                      {"She was comparing Ottoman tile patterns to Mamluk ones along the Nile",                    "cairo",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He kept staring at a Nile River postcard pinned to the gallery wall",                      "cairo",    CARMEN_CLUE_POSITIVE},
                      {"She mentioned the Whirling Dervishes' hometown as her next cultural stop",                 "konya",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"The suspect ordered a ferry ticket and asked about the Whirling Dervishes",                "konya",    CARMEN_CLUE_POSITIVE},
                      {"She was raving about the food scene in a city where church bells mix with the adhan",       "beirut",   CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She mentioned a city where you can ski in the morning and swim the Mediterranean by noon", "beirut",   CARMEN_CLUE_POSITIVE},
                      {"He was reading about Ottoman bridges in a Balkan city known for its coppersmiths",         "sarajevo", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said the world's best collection of Islamic calligraphy is just a short flight south",  "doha",    CARMEN_CLUE_POSITIVE},
                      {"She mentioned pearl diving traditions across the Gulf to the southeast",                    "muscat",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He mentioned old dhow routes along the Omani coast",                                       "muscat",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was dreaming aloud about Mughal gardens and Wazir Khan's tilework",                     "lahore",  CARMEN_CLUE_POSITIVE},
                      {"She asked the imam about Persian tile patterns and dome geometry",                          "isfahan", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was studying Farsi on his phone and comparing dome geometry",                           "isfahan", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was raving about volcanic highland coffee from Java's most artistic city",             "bandung",      CARMEN_CLUE_POSITIVE},
                      {"He was researching Charminar and biryani in India's Nizam city",                           "hyderabad",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He mentioned flying to Bangladesh for a friend's wedding",                                 "dhaka",       CARMEN_CLUE_POSITIVE},
                      {"She said the Laad Bazaar bangles in India's pearl city are even prettier",                  "hyderabad",   CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said the mihrab here can't match the one inside Istiqlal across the strait",            "jakarta",     CARMEN_CLUE_POSITIVE},
                      {"She compared the batik here to the highland city in Java where it's made by hand",          "bandung",     CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He mentioned wanting to see the white marble mosque that seats 40,000 worshippers",        "abu_dhabi", CARMEN_CLUE_POSITIVE},
                      {"She said the glittering skyline just an hour's drive away puts this one to shame",          "dubai",     CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was comparing spice prices to the souks in the city with the world's tallest tower",    "dubai",     CARMEN_CLUE_POSITIVE},
                      {"She kept talking about the Louvre branch just across the Gulf",                             "abu_dhabi", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She had a campus visitor badge from a university in the Emirates' capital",                "abu_dhabi", CARMEN_CLUE_POSITIVE},
                      {"He was checking Emirates flights to the mega-mall across the Gulf",                         "dubai",     CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said the Museum of the Future in the Gulf's glitziest city is his next stop",           "dubai",     CARMEN_CLUE_POSITIVE},
                      {"She mentioned studying at a Gulf university where East meets West academically",            "abu_dhabi", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"The suspect was reading about Pharaonic architecture",                                     "cairo",  CARMEN_CLUE_POSITIVE},
                      {"He mentioned a city where you can party till dawn and hear church bells with the adhan",    "beirut", CARMEN_CLUE_POSITIVE},
                      {"The site guards have not seen any strangers today", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "amman", "The Citadel",              "landmark", c, 3); }
    { ClueData c[] = {{"She was converting dinars to Lebanese pounds and checking nightlife reviews",               "beirut", CARMEN_CLUE_POSITIVE},
                      {"He asked about the city where they built the world's tallest tower in the desert",          "dubai",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was checking Emirates airline schedules to a Gulf megacity",                            "dubai",  CARMEN_CLUE_POSITIVE},
                      {"He was exchanging dinars for Egyptian pounds at the currency desk",                         "cairo",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"The suspect mentioned the Atlas Mountains are just a train ride away",                     "marrakech", CARMEN_CLUE_POSITIVE},
                      {"He was studying a map of West Africa with a city on the Atlantic coast circled",            "dakar",     CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was asking about flights to Senegal at a travel agency",                               "dakar",     CARMEN_CLUE_POSITIVE},
                      {"He had a guidebook for the Egyptian pyramids in his shopping bag",                          "cairo",     CARMEN_CLUE_POSITIVE},
                      {"The shopkeeper hasn't seen any strangers today", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "casablanca", "Habous Quarter",    "market",   c, 3); }
    { ClueData c[] = {{"She was exchanging dirhams for Egyptian currency at the bureau de change",                  "cairo",     CARMEN_CLUE_POSITIVE},
                      {"He said the city with the world's oldest university has finer examples of this style",      "fez",       CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said the medina in Morocco's oldest imperial city makes this look modern",               "fez",       CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said even the world's largest mosque can't match the Islamic arts collection across the strait", "kuala_lumpur", CARMEN_CLUE_POSITIVE},
                      {"She was checking train schedules to a volcanic highland city in West Java",                          "bandung",      CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She mentioned visiting the Paris of Java for its colonial architecture and hot springs",   "bandung",      CARMEN_CLUE_POSITIVE},
                      {"He said the nasi lemak across the strait in Malaysia is better than anything here",          "kuala_lumpur", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was reading about the city where Sinan built his masterpiece mosques",                  "istanbul", CARMEN_CLUE_POSITIVE},
                      {"She mentioned wanting to study at the world's oldest university in Morocco",                "fez",      CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"The suspect muttered something about the Bosphorus at sunset",                             "istanbul", CARMEN_CLUE_POSITIVE},
                      {"She had a printout of cheap flights to a Moroccan city with the oldest medina",             "fez",      CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was comparing the Silk Road tilework here to the ones in the city that's half the world", "isfahan", CARMEN_CLUE_POSITIVE},
                      {"She said the food scene in Pakistan's cultural capital would blow this bazaar away",          "lahore",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was buying dried fruits to bring to friends near the Badshahi Mosque",                  "lahore",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She photographed Soviet mosaics and said a Mughal city's tilework puts them to shame",     "lahore",  CARMEN_CLUE_POSITIVE},
                      {"He said the tilework here is beautiful but a certain Persian city's is unmatchable",         "isfahan", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said this park's view rivals the ancient Citadel perched over a Levantine capital",     "amman",      CARMEN_CLUE_POSITIVE},
                      {"She mentioned connecting through the Moroccan city that shares its name with a famous film", "casablanca", CARMEN_CLUE_POSITIVE},
                      {"The park gardener hasn't noticed anyone out of place", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "cairo", "Al-Azhar Park",          "park",     c, 3); }
    { ClueData c[] = {{"She was checking Royal Air Maroc flights on her laptop",                                    "casablanca", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was sketching the muqarnas and comparing them to the white marble mosque that seats 40,000", "abu_dhabi", CARMEN_CLUE_POSITIVE},
                      {"He was checking visa requirements for Jordan",                                                     "amman",     CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was comparing Phoenician artifacts to ones from a city perched over a desert Citadel", "amman",    CARMEN_CLUE_POSITIVE},
                      {"He had a Turkish Airlines boarding pass stub in his jacket",                                "istanbul", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"The suspect asked a storyteller about the oldest university in the world",                 "fez",        CARMEN_CLUE_POSITIVE},
                      {"She was searching for flights to the Moroccan city named in a classic Bogart film",         "casablanca", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said he's catching a train to Morocco's economic capital tonight",                       "casablanca", CARMEN_CLUE_POSITIVE},
                      {"She said the city with the world's oldest university has finer art",                        "fez",        CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He had a train ticket to Morocco's oldest imperial city in his back pocket",               "fez",        CARMEN_CLUE_POSITIVE},
                      {"She mentioned visiting the Art Deco district in Morocco's coastal business hub",            "casablanca", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was comparing this mosque to one in a Bengali river capital surrounded by waterways",   "dhaka",     CARMEN_CLUE_POSITIVE},
                      {"She was reading about Timurid architecture in a city famous for its Soviet-era metro",      "tashkent",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He mentioned comparing these Mughal walls to Silk Road forts in Central Asia's largest city", "tashkent", CARMEN_CLUE_POSITIVE},
                      {"She was reading restaurant reviews from the Gulf city with the world's tallest building",      "dubai",    CARMEN_CLUE_POSITIVE},
                      {"The fort guard has not seen any suspicious visitors", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "lahore", "Lahore Fort",          "landmark", c, 3); }
    { ClueData c[] = {{"He said the Pakistani restaurants in the Gulf's glitziest city can't compare to the real thing", "dubai",     CARMEN_CLUE_POSITIVE},
                      {"She was comparing the biryani here to the famous Hyderabadi dum style across the border",        "hyderabad", CARMEN_CLUE_POSITIVE},
                      {"The waiter doesn't recall anyone unusual this week", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "lahore", "Food Street",          "market",   c, 3); }
    { ClueData c[] = {{"He mentioned shipping a box of silk fabric to a friend near the Charminar",                "hyderabad", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"The suspect said he'd rather be where the call to prayer echoes across two continents",    "istanbul", CARMEN_CLUE_POSITIVE},
                      {"He was comparing the Sufi lodges here to the mystic gardens in a Persian oasis city",       "isfahan",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said the Sultan's Grand Mosque on the Arabian Sea coast has comparable grandeur",       "muscat", CARMEN_CLUE_POSITIVE},
                      {"She said she prefers the I.M. Pei-designed museum on the peninsula for Islamic art",        "doha",   CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said a nearby Gulf capital's collection of Islamic art is even deeper",                  "doha",   CARMEN_CLUE_POSITIVE},
                      {"She was reading about Saladin's Citadel on the Nile and comparing palaces",                 "cairo",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was exchanging dirhams for Egyptian pounds at the park gift shop",                      "cairo",  CARMEN_CLUE_POSITIVE},
                      {"He said the Museum of the Future in the Gulf's glitziest city is next on his list",          "dubai",  CARMEN_CLUE_POSITIVE},
                      {"The park ranger says it's been quiet all day", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "abu_dhabi", "Mangrove Park",       "park",     c, 3); }
    { ClueData c[] = {{"He was checking Emirates flights to the mega-mall across the Gulf",                         "dubai",  CARMEN_CLUE_POSITIVE},
                      {"She mentioned kayaking near a port city where frankincense ships once sailed",               "muscat", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was reading about the old Omani stone houses on a spice island off East Africa",        "zanzibar", CARMEN_CLUE_POSITIVE},
                      {"She said a desert city's cultural scene rivals this one -- its opera season is next month",  "dubai",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She mentioned visiting the world's most densely populated city where rickshaws outnumber cars", "dhaka",    CARMEN_CLUE_POSITIVE},
                      {"He had a documentary about Swahili trading ports bookmarked on his tablet",                      "zanzibar", CARMEN_CLUE_POSITIVE},
                      {"The swimmers here haven't seen any strangers", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "muscat", "Bimmah Sinkhole",        "landmark", c, 3); }
    { ClueData c[] = {{"He was checking Emirates airline schedules heading west across the Gulf",                   "dubai",    CARMEN_CLUE_POSITIVE},
                      {"She said he's heading east to a river delta capital in South Asia",                          "dhaka",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She said the Art Deco of a Moroccan coastal city reminded her of home",                    "casablanca", CARMEN_CLUE_POSITIVE},
                      {"He was researching how the slave trade connected West Africa to the land of the Pharaohs",  "cairo",      CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She said the history museums along the Nile cover similar stories of trade and movement",   "cairo",      CARMEN_CLUE_POSITIVE},
                      {"He mentioned booking a dhow trip along the East African coast to a spice island",           "zanzibar",   CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was reading about old Omani stone houses in a Swahili port off the East African coast",  "zanzibar",   CARMEN_CLUE_POSITIVE},
                      {"She was booking a Royal Air Maroc flight heading north to Morocco",                          "casablanca", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was comparing Braga Street to the famous hawker lane near the twin towers",             "kuala_lumpur", CARMEN_CLUE_POSITIVE},
                      {"She said the world's largest mosque in Indonesia's capital makes this city look tiny",       "jakarta",      CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He had a train ticket back to the Javanese megacity on the coast",                         "jakarta",      CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He mentioned catching the evening train back to Indonesia's capital",                       "jakarta",      CARMEN_CLUE_POSITIVE},
                      {"She was comparing the tea plantations here to the Cameron Highlands near the twin towers",  "kuala_lumpur", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said the Mevlana Museum in the city where Rumi rests is his next spiritual stop",       "konya",    CARMEN_CLUE_POSITIVE},
                      {"She was sipping tea and reading about Soviet metro mosaics in Central Asia's largest city",  "tashkent", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said he's following the Silk Road east to Central Asia's largest city",                  "tashkent", CARMEN_CLUE_POSITIVE},
                      {"She mentioned the desert city skyline with the world's tallest tower as her next stop",      "dubai",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She said the Wazir Khan Mosque in the Mughal heartland has even more intricate tiles",     "lahore",       CARMEN_CLUE_POSITIVE},
                      {"He was haggling for a rickshaw and talking about frankincense merchants across the ocean",   "muscat",       CARMEN_CLUE_POSITIVE},
                      {"The caretaker says only locals have visited today", NULL, CARMEN_CLUE_NEGATIVE}};
      add_site(w, "dhaka", "Star Mosque",             "mosque",   c, 3); }
    { ClueData c[] = {{"He mentioned sailing to a port city on the Arabian Sea along an old trade route",           "muscat",       CARMEN_CLUE_POSITIVE},
                      {"She was buying bangles and said the Charminar city has them even cheaper",                   "hyderabad",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was comparing the river chaos to nothing -- India's Nizam city is calmer",              "hyderabad",    CARMEN_CLUE_POSITIVE},
                      {"She was checking Malaysia Airlines prices on her phone",                                     "kuala_lumpur", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said the Red City at the foot of the Atlas Mountains is easier to navigate",            "marrakech",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"The suspect posted a panoramic photo with a hashtag about the Moroccan city from the classic Bogart film", "casablanca", CARMEN_CLUE_POSITIVE},
                      {"He said the city at the foot of the Atlas Mountains is more fun but this one has more soul",                 "marrakech",  CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She mentioned the Omani sultans who once ruled this island",                               "muscat",   CARMEN_CLUE_POSITIVE},
                      {"He had a printout of flights to a West African city where Sufi brotherhoods lead prayers",  "dakar",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She mentioned wanting to visit Senegal's Atlantic coast next",                             "dakar",    CARMEN_CLUE_POSITIVE},
                      {"He said the great Mamluk mosques by the pyramids put this island to shame",                 "cairo",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was reading about parks along the Nile on her phone",                                  "cairo",    CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He was comparing the old Omani fort here to the Sultan's palace across the sea",           "muscat",   CARMEN_CLUE_POSITIVE},
                      {"She was eating Zanzibar pizza and said the street food by the pyramids is even better",      "cairo",   CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"He said this mosque is beautiful but the one in the Gulf city with the tallest tower is more famous", "dubai",        CARMEN_CLUE_POSITIVE},
                      {"She was researching street food near the twin towers across the Indian Ocean",                        "kuala_lumpur", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She said Malaysia's capital has even more impressive Islamic art collections",              "kuala_lumpur", CARMEN_CLUE_POSITIVE},
    ...
    { ClueData c[] = {{"She was buying bangles and said the river capital of Bengal has them even cheaper",         "dhaka",        CARMEN_CLUE_POSITIVE},
                      {"He mentioned flying to Pakistan next to see the Badshahi Mosque",                           "lahore",       CARMEN_CLUE_POSITIVE},
